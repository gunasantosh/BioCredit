...
con = mysql.connector.connect(host='localhost', user='root', password='mypassword', database='dapp')
...
def process_form():
    ...
    if meter_reading:
        query = "INSERT INTO captured_image (meter_reading, image, username) VALUES ('{}','{}','{}')".format(meter_reading, image, username)
        cursor.execute(query)
        con.commit()
